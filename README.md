...
A validação estrutural não substitui um playtest no mGBA. Diálogos, colisões,
transições de mapa, batalhas e efeitos ainda precisam de QA em emulador antes
de chamar a tradução de 100% revisada.
